...
class Woo_Open_Graph {
	...
	private function load_dependencies() {
		...
		$required_files = array(
			...
			$includes_dir . 'wog-functions.php',
	 ...
	 *
	 * Since WordPress 6.7, translations are loaded automatically.
	 * This hook is retained for forward compatibility.
	 */
	public function load_textdomain() {
		// Translations are auto-loaded by WordPress 6.7+.
			...
			<p>
				...
				echo wp_kses(
					sprintf(
						...
						esc_html__( 'Open Graph for WooCommerce requires WooCommerce to be installed and active. %s', 'woo-open-graph' ),
						'<a href="' . esc_url( admin_url( 'plugin-install.php?s=woocommerce&tab=search&type=term' ) ) . '">' . esc_html__( 'Install WooCommerce', 'woo-open-graph' ) . '</a>'
					),
	...
	public function activate() {
		if ( ! $this->is_woocommerce_active() ) {
			...
			wp_die(
				esc_html__( 'Open Graph for WooCommerce requires WooCommerce to be installed and active.', 'woo-open-graph' ),
				esc_html__( 'Plugin Activation Error', 'woo-open-graph' ),
