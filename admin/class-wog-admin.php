    ...
    public function admin_page() {
        ...
        <div class="wrap wog-admin-wrap">
            <div class="wog-admin-header">
                ...
                <p class="description"><?php _e('Configure how your WooCommerce products appear when shared on social media platforms. This plugin works alongside your existing SEO plugin to fill any gaps.', 'woo-open-graph'); ?></p>
            </div>
                ...
                <div class="wog-sidebar">
                    <div class="wog-sidebar-box">
                        <div class="wog-card-header">
                            <h3><span class="dashicons dashicons-dashboard"></span> <?php _e('Current Status', 'woo-open-graph'); ?></h3>
                        </div>
                    ...
                    <div class="wog-sidebar-box">
                        <div class="wog-card-header">
                            <h3><span class="dashicons dashicons-info"></span> <?php _e('Plugin Information', 'woo-open-graph'); ?></h3>
                        </div>
                        <div class="wog-card-body">
                            <p><strong><?php _e('Version:', 'woo-open-graph'); ?></strong> <?php echo WOG_VERSION; ?></p>
                            <p><strong><?php _e('Compatible with:', 'woo-open-graph'); ?></strong> Yoast, RankMath, SEOPress</p>
                            <p><strong><?php _e('Auto-generates:', 'woo-open-graph'); ?></strong> <?php _e('Schema, Open Graph, Twitter Cards', 'woo-open-graph'); ?></p>
                            
                            <hr>
                            
                            <h4><?php _e('Important Notes', 'woo-open-graph'); ?></h4>
                            <ul>
                                <li><?php _e('Uses product featured images automatically', 'woo-open-graph'); ?></li>
                                <li><?php _e('Individual products can have custom titles/descriptions', 'woo-open-graph'); ?></li>
                                <li><?php _e('Works alongside existing SEO plugins', 'woo-open-graph'); ?></li>
                                <li><?php _e('Uses WordPress built-in caching for performance', 'woo-open-graph'); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        function wogGenerateSitemap(button) {
            ...
            button.textContent = '<?php _e('Generating...', 'woo-open-graph'); ?>';
            ...
            .finally(() => {
                ...
                button.textContent = '<?php _e('Generate Now', 'woo-open-graph'); ?>';
            });
        }
        
        function wogTestSitemap(button) {
            button.disabled = true;
            button.textContent = '<?php _e('Testing...', 'woo-open-graph'); ?>';
            ...
            .finally(() => {
                button.disabled = false;
                button.textContent = '<?php _e('Test Sitemaps', 'woo-open-graph'); ?>';
            });
        }
